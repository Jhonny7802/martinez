    ...
    public function run()
    {
        ...
        $projects = [
            [
                ...
                'project_summary' => 'Complejo residencial de 120 apartamentos en 4 torres de 15 pisos cada una.',
                'notes' => 'Proyecto incluye áreas verdes, piscina, gimnasio y parqueo subterráneo.',
            ...
            [
                ...
                'project_summary' => 'Centro comercial de 3 niveles con 80 locales comerciales.',
                'notes' => 'Incluye área de comidas, cines y estacionamiento para 500 vehículos.',
                'status' => 2, // En progreso
            ...
            [
                ...
                'project_summary' => 'Complejo industrial con 5 bodegas de 2000m² cada una.',
                'notes' => 'Incluye oficinas administrativas y área de carga y descarga.',
                'status' => 1, // Iniciado
            ...
            [
                ...
                'project_summary' => 'Remodelación completa del ala norte del hospital.',
                'notes' => 'Modernización de quirófanos y área de emergencias.',
                'status' => 5, // Pendiente
                'project_budget' => 5500000.00,
                'created_at' => now(),
                'updated_at' => now(),
            ],
        ];
