...
-- =====================================================
-- COMANDOS PARA EJECUTAR EN MYSQL
-- =====================================================
...
1. Conectar a MySQL:
   mysql -u root -p martinez

2. O desde phpMyAdmin:
   - Seleccionar base de datos "martinez"
   - Ir a pestaña SQL
   - Copiar y pegar este código
   - Ejecutar

3. Verificar tablas creadas:
   SHOW TABLES LIKE '%cai%';
   SHOW TABLES LIKE '%design%';

4. Verificar estructura:
   DESCRIBE cai_billings;
