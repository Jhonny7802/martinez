<div class="row">
    <div class="form-group col-sm-6">
        ...
        {{ Form::text('subject', null, ['class' => 'form-control','required','autocomplete' => 'off','placeholder'=>__('messages.goal.subject')]) }}
    </div>
    <div class="form-group col-sm-6">
        {{ Form::label('goal_type', __('messages.goal.goal_type').':') }}<span class="required">*</span>
        {{ Form::select('goal_type', $goalTypes, null, ['class' => 'form-control','required','placeholder' => __('messages.placeholder.select_goal_type'), 'id' => 'goalTypeId']) }}
    </div>
</div>
<div class="row">
    <div class="form-group col-sm-6">
...
<div class="row">
    <div class="form-group col-sm-12 col-lg-6 col-md-12">
        ...
        <div class="input-group">
            ...
            {{ Form::text('start_date', isset($goal->start_date) ? $goal->start_date : null, ['class' => 'form-control startDatepicker', 'required','autocomplete' => 'off','placeholder'=> __('messages.goal.start_date')]) }}
        </div>
    </div>
    <div class="form-group col-sm-12 col-lg-6 col-md-12">
        ...
        <div class="input-group">
            ...
            {{ Form::text('end_date', isset($goal->end_date) ? $goal->end_date : null, ['class' => 'form-control endDatepicker', 'required','autocomplete' => 'off','placeholder'=> __('messages.goal.end_date')]) }}
        </div>
    </div>
</div>
<div class="row">
